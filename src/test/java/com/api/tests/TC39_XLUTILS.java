...
public class TC39_XLUTILS {
	...
	@Test
	public static int getRowsCount(String xlfile, String xlsheet) throws IOException {		// let us get the # of rows
	...
	@Test
	public static int getColumnsCount(String xlfile, String xlsheet) throws IOException {		// let us get the # of columns
		...
		XSSFRow row = ws.getRow(1);							// pointing to the row specified
